            ...
            <div className="tab-content">
                ...
                <div className="tab-pane fade in active show" id="all" >
                    ...
                    <div className="row no-gutters justify-content-between">
                        <div className="my-3 w-auto" style={{ fontSize: "2rem", fontWeight: "600px" }}>Tất cả</div>
                ...
                <div className="tab-pane fade in" id="promo" style={{ overflow: "auto" }}>
                    <div className="my-3 w-auto" style={{ fontSize: "2rem", fontWeight: "600px" }}>Khuyến mại</div>
                    <Paginate />
                    <div style={{ maxHeight: "450px", overflow: "auto" }}>
